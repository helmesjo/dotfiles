...
pacpackages="mesa xorg vim git bc rxvt-unicode alsa-utils lightdm-gtk-greeter i3-gaps i3blocks nitrogen rofi compton ttf-font-awesome adobe-source-code-pro-fonts ttf-nerd-fonts-symbols neovim nodejs ccls ctags"
#aurpackages=""
